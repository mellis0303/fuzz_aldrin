...
type TaskResultInspector func(result *executorV1.TaskResult)
...
func (sa *SimulatedAggregator) SubmitTaskResult(ctx context.Context, result *executorV1.TaskResult) (*v1.SubmitAck, error) {
